...
<!-- content -->
           <div class="bg-grey-200 rounded-xl p-4">
                <h1 class="text-3xl ml-3 mb-2">Form Input Data</h1>
                <form action="" method="post">
                    <div class="mb-3 bg-pink-300 rounded-lg p-4 m-3">
                        ...
                        <div class="grid gap-2">
                           <button name="submit" class="bg-blue-500 hover:bg-blue-800 p-3 m-4 rounded-lg text-white" type="submit">Submit</button>
                        </div>
                    </div>
                </form>
            </div>
